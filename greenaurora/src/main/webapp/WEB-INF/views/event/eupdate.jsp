...
<html lang="ko">
    ...
    <div class="main_public">
        ...
        <section class="list">
            ...
            <div>
            <form:form modelAttribute="event" method="post" class="form" enctype="multipart/form-data">
			    <div class="form-div">
			        <div class="form-label">이벤트 제목: </div>
			        <form:input path="eventName" class="form-control" value="${event.eventName}"/>
			    </div>
			    
			    <div class="form-div">
			        <div class="form-label">따릉이 정거장: </div> <!-- 나중에 시간 되면 조회하는 기능도 추가할 것 -->
			        <form:input path="stationNumber" class="form-control" value="${event.stationNumber}"/>
			    </div>
			    
			    <div class="form-div">
			        <div class="form-label">추가 포인트: </div>
			        <form:input path="plusPoint" class="form-control" value="${event.plusPoint}"/>
			    </div>
			    
			    <div class="form-div">
				    <div class="form-label">이벤트 시작일: </div>
				    <form:input type="date" path="startDt" class="form-control" value="${event.startDt}"/>
			    </div>
			    
			    <div class="form-div">
				    <div class="form-label">이벤트 종료일: </div>
				    <form:input type="date" path="endDt" class="form-control" value="${event.endDt}"/>
			    </div>
			    ...
			    <div class="form-div">
					...
					<form:input type="hidden" path="eventContent"  name="contents" id="contents"  value="${event.eventContent}"/>
			    ...
			    <div class="form-div">
			        ...
			        <input type="file" name="eventThumb" class="form-control"  value="${event.eventThumb}"/>
			    </div>
