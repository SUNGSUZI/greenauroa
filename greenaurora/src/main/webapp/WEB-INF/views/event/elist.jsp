        ...
        <!-- 컨텐츠 작업 start -->
         <section class="list">
            ...
            <div class="list_content list_event">
			    ...
			    <c:if test="${event.state == 'A' && principal.authorities[0].authority == 'ROLE_ADMIN'}">
			        <div class="event">
			        	<div class="event_content">
						    <a href="/event/edetail/${event.eventKey}">
						        <div class="event_thumb">
						        ...
						        <div class="event_text">
						            <div class="event_title">${event.eventName} <img class="list_lock" src="/images/icon8-lock.png"></div>
						            <div class="event_date">${event.createDt}</div>
						        </div>
						    </a>
			            </div>
