    ...
    <div class="container">
        ...
        <div class="right-panel signup-panel">
            <div class="signup-container">
                ...
                <form class="signup-form" action="/svc/admin/insert"  method="post" modelAttribute="memberForm">
                ...
                <div class="return-login">
                    <a href="/" class="return-link">로그인 페이지로 돌아가기</a>
                </div>
            </div>
        </div>
    </div>

    <script src="/js/signup2_admin.js">    
